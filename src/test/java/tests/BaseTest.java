...
//                returnDriver.get("edge://settings/downloads");
//                if(returnDriver.findElement(By.xpath("//input[@aria-label='Open Office files in the browser']")).isEnabled())
//                    returnDriver.findElement(By.xpath("//input[@aria-label='Open Office files in the browser']")).click();
                break;
...
//                if(testOS.equalsIgnoreCase("windows"))
//                {
